...
singleRangeParser = sepBy regularValueParser comma

singleTupleRangeParser :: Parser [[IncompleteAtomicValue]]
singleTupleRangeParser = sepBy tupleValueParser comma

multiRangeParser :: Parser [[IncompleteAtomicValue]]
multiRangeParser = sepBy multiValueParser comma

multiTupleRangeParser :: Parser [[[IncompleteAtomicValue]]]
multiTupleRangeParser = sepBy multiTupleValueParser comma
